...
def build_arg_parser():
    ...
    p.add_argument("--lambda-seg", type=float, default=5.0, help="Initial GradNorm weight for segmentation")
    p.add_argument("--lambda-cls", type=float, default=1.0, help="Initial GradNorm weight for classification")
    p.add_argument("--gradnorm-alpha", type=float, default=1.5, help="GradNorm asymmetry exponent")
